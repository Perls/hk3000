...
export const BowlBuilder: React.FC<BowlBuilderProps> = ({
  ...
  // If we are scraping or in the 'NEW' version mode, show the full importer view
  if (isScraping || currentVersionId === 'NEW') {
      return (
          <div className="h-full min-h-[500px]">
              <div className="h-full bg-stone-50 rounded-xl border border-stone-200 overflow-hidden shadow-sm">
                  <MenuImporter 
                      restaurant={{ 
                          id: 'temp', 
                          name: restaurantName, 
